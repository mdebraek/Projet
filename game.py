...
def get_AI_orders(game_data:dict, player:int)->list:
    """get AI orders (basic)
    ...
    Version
    -------
    specification: Mitta Kylian, De Braekeleer Mickaël (v.1 13/03/25)
    implementation: Mitta Kylian, De Braekeleer Mickaël (v.1 13/03/25)
